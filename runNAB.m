...
%     end
    ...
    %% Time to process
    htmau_timing_dataset = diff([time_per_dataset datetime]);
    fprintf ('\nProcessing Time is: %s\n',htmau_timing_dataset);
    save (sprintf('Output/time_SMRM_%s.mat',name),'htmau_timing_dataset','-append');    
...
% 
%     end
%     htmau_timing_dataset(i) = diff([time_per_dataset datetime]);
%     fprintf ('\nProcessing Time is: %s\n',htmau_timing_dataset(i));
end
% 
%
% 
